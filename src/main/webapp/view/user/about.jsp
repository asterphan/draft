			...
			<div class="about-content py-lg-5 py-3">
				<div class="row">
					...
					<div class="col-lg-6 about-info">
						...
						<p class="my-xl-4 my-lg-3 my-md-4 my-3">Lorem Ipsum is simply
			...
			<div class="bottom-sub-grid-content py-lg-5 py-3">
				<div class="row">
					<div class="col-lg-4 bottom-sub-grid text-center">
						...
						<h4 class="sub-tittle-w3layouts my-lg-4 my-3">Satisfaction
							Guaranteed</h4>
			...
			<div class="row">
				<div class="col-md-12 middle-slider my-4">
					<div class="middle-text-info ">
						...
						<h3 class="tittle-w3layouts two text-center my-lg-4 mt-3">Summer
							Flash sale</h3>
